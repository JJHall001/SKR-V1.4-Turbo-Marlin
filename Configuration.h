...
#define STRING_CONFIG_H_AUTHOR "JJ Hall Config" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Lets Print Something"
...
//#define MAGNETIC_PARKING_EXTRUDER
  ...
  #define PARKING_EXTRUDER_PARKING_X { -40, 184 }     // X positions for parking the extruders
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38, -31, -1 }
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  //#define EEPROM_AUTO_INIT  
   // Init EEPROM automatically on any errors.
    //CHANGED THIS //#define EEPROM_INIT_NOW 
